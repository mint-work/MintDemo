package com.example.mintdemo.Tool.System.Voice;
...
/**
 * 创建人:Mint
 * 创建时间:2022/11/20/10:22
 * 功能描述:
 * 参考 https://codeantenna.com/a/faEIv8vEsq
 * 使用方法播放
 * MediaPlayerManager mediaPlayerManager = new MediaPlayerManager(this);
 *         mediaPlayerManager.playBackgroundMusic("game_bg.mp3", true);
 *停止音乐：
